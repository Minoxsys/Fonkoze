...
namespace Web.Areas.MessagesManagement.Controllers
{
    public class WarehouseController : Controller
    {
        ...
        [HttpGet]
        public JsonResult GetMessagesFromWarehouse(MessagesIndexModel indexModel, OverviewInputModel input = null)
        {
            var districtId = input == null ? Guid.Empty : input.DistrictId;
            return Json(SmsQueryService.GetMessagesFromOutpost(indexModel, OutpostType.Warehouse, districtId), JsonRequestBehavior.AllowGet);
        }
